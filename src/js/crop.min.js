...
var ImageCrop=function(e){var o=this;_privateObject=Object.assign(_privateObject,e),document.body.innerHTML+=_privateObject.cropModal||_privateObject.getCropModal(),o.initCrop=function(e){_privateObject.input=e;var t=document.getElementById("crop_demo");o.checkValidations()&&($image_crop=new Croppie(t,_privateObject),o.showCropModal())},o.checkValidations=function(){var e=0;return validTypes=_privateObject.validTypes.split("|"),uploadedFileType=_privateObject.input.files[0].type,validTypes.includes(uploadedFileType.replace("image/",""))||(alert("You uploaded an invalid file"),++e),!e},o.showCropModal=function(){o.fileReader(_privateObject.input.files[0],function(e){$image_crop.bind({url:e.target.result})}),document.getElementById("cropModal").style.display="block"},o.getSourceBlob=function(){return _privateObject},o.fileReader=function(e,t){var a=new FileReader;a.readAsDataURL(e),a.onload=t},o.setCropObject=function(e){_privateObject.cropData=e},o.getData=function(){return _privateObject.cropData},document.getElementById("crop_image").addEventListener("click",function(){var r=document.getElementById("cropModal");$image_crop.result(_privateObject.imageResult).then(function(e){if(_privateObject.showPreview)switch(_privateObject.imageResult.type){case"base64":for(var t=0,a=document.querySelectorAll(_privateObject.imagePreview+" img");t<a.length;)a[t].src=e,++t;_privateObject.cropData=e;break;case"html":if(_privateObject.imagePreview.includes(".")){for(t=0,a=document.getElementsByClassName(_privateObject.imagePreview.replace(".",""));t<a.length;)a[t].innerHTML="",a[t].appendChild(e),++t;_privateObject.cropData=e;break}var i=document.getElementById(_privateObject.imagePreview.replace("#",""));i.innerHTML="",i.appendChild(e),_privateObject.cropData=e;break;case"blob":o.fileReader(e,function(e){var t=new Image;t.onload=function(){context.drawImage(t,100,100)};for(var a=0,i=document.querySelectorAll(_privateObject.imagePreview+" img");a<i.length;)i[a].src=e.target.result,++a}),_privateObject.cropData=e}return r.style.display="none",o.setCropObject(e),e}),$image_crop.destroy()});for(var t=0,a=document.getElementsByClassName("close");t<a.length;)a[t].addEventListener("click",function(){$image_crop.destroy(),document.getElementById("cropModal").style.display="none"}),++t},_privateObject={crop:!0,input:"",cropModal:"",enableExif:!0,showZoomer:!0,validTypes:"jpg|jpeg|png",showPreview:!1,modalHeader:"Crop Image",imagePreview:"",modalButtonText:"Crop",boundary:{width:250,height:250},viewport:{width:200,height:200,type:"square"},imageResult:{type:"base64",size:"viewport",format:"png",quality:1,circle:null},getCropModal:function(){return"<div id='cropModal' class='popup-wrap crop-popup-wrap'><div class='crop-container'><div class='crop-modal-content'><span class='close'>&times;</span><div class='crop-modal-head'><h2 class='text-gradient'>"+this.modalHeader+"</h2></div><div class='crop-modal-wrapper'><div id='crop_demo'></div><div class='crop-btn-wrap'><button type='button' class='ok-btn' id='crop_image'>"+this.modalButtonText+"</button></div></div></div></div></div>"}};